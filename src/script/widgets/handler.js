import { translateDOM } from "/src/script/core/i18n.js";
import { getSettings, saveSettings, subscribe } from "/src/script/core/storagehandler.js";
import { startClockUpdates, stopClockUpdates } from "/src/script/widgets/clock/clock.js";
import { startWeatherUpdates, stopWeatherUpdates } from "/src/script/widgets/weather/weather.js";
import { Icons } from "/src/script/core/icon.js";
...
function cleanupWidget() {
    ...
    widgetSubscriptions.forEach((unsub) => unsub());
    widgetSubscriptions = [];
    document.getElementById("widgets_container").innerHTML = "";
}
...
function startEditMode() {
    ...
    Promise.all([import("/src/script/core/UI.js"), import("/src/script/core/i18n.js")]).then(([{ openCustomPopup, showNotification, createSlider }, { t }]) => {
