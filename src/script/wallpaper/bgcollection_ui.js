...
import { openCustomPopup, showNotification } from "/src/script/core/UI.js";
...
import {
    ...
    getImageDimensions,
} from "/src/script/wallpaper/bgcollection.js";
import { getCurrentProviderData, applyCollectionItem } from "/src/script/wallpaper/bgapi.js";
        ...
        bulkDeleteBtn.addEventListener("mousedown", () => {
            ...
            dialogContent.querySelector("#confirm_ok_btn").onmousedown = async () => {
                ...
                setTimeout(async () => {
                    ...
                    const { getSettings, saveSettings } = await import("/src/script/core/storagehandler.js");
...
async function renderGrid(items, grid, emptyState) {
    ...
    const { getSettings } = await import("/src/script/core/storagehandler.js");
